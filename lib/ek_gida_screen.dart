          ...
          Container(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                  'assets/bg1.png',
                ), // Kendi görsel yolunu kontrol et
                fit: BoxFit.cover,
              ),
            ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Colors.white.withOpacity(
                      0.9,
                    ), // Arka plana uyum için opaklık eklendi
  ...
  Future<void> syncMinistryData() async {
    try {
      ...
      final List<String> blackList = [
        ...
        "BaşkanlığımızDaire BaşkanıGörev Tanımı",
        "DokümanlarAfişlerBroşürlerİngilizce YayınlarKitaplarRehberlerProgramlarSunumlarVideolar",
          ...
          if (url.contains('okul-oncesi')) {
            ...
            for (var element in allElements) {
              ...
              if (startCollecting) {
                ...
                bool isBadData = blackList.any(
                  (badWord) => text.contains(badWord),
                );
            ...
            for (var element in allElements) {
              ...
              if (element.localName == 'p' && text.length > 25) {
                ...
                var items = element
                    ...
                    .map((e) => e.text.trim())
                    .where(
                      (t) => t.length > 5 && !blackList.contains(t),
                    ); // Liste içindeki fazlalıkları siler
                if (items.isNotEmpty) {
